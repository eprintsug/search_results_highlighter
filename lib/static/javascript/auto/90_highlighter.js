...
/**
 * Removes stopwords (as in lib/defaultcfg/cfg.d/indexing.pl) and words shorter 
 * than 3 characters
 * @param {array} An array of strings
 */
function remove_stopwords(arr){
const stopwords = ["this", "are","which", "with","that", "can",  "from","these",
"those","the","you","for","been","have","were","what","where","is","and"];
...
function get_search_params(search_field){
    let parameters = {};
    // got the regex idea from AwokeKnowing's brilliant answer 
    // at https://bit.ly/2Rp7Hyk
    const re = RegExp("[?&]+([^=&]+)=([^&]*)", "gi"); 
